...
// node_modules/youtube-search-api/dist/index.js
var require_dist = __commonJS({
  "node_modules/youtube-search-api/dist/index.js"(exports) {
    ...
    (function(ErrorCodes2) {
      ...
      ErrorCodes2["INIT_DATA_ERROR"] = "INIT_DATA_ERROR";
      ErrorCodes2["PLAYER_DATA_ERROR"] = "PLAYER_DATA_ERROR";
      ErrorCodes2["INVALID_PLAYLIST"] = "INVALID_PLAYLIST";
      ErrorCodes2["INVALID_VIDEO_ID"] = "INVALID_VIDEO_ID";
      ErrorCodes2["INVALID_CHANNEL_ID"] = "INVALID_CHANNEL_ID";
      ErrorCodes2["RATE_LIMIT_ERROR"] = "RATE_LIMIT_ERROR";
      ErrorCodes2["PARSE_ERROR"] = "PARSE_ERROR";
      ErrorCodes2["UNKNOWN_ERROR"] = "UNKNOWN_ERROR";
    ...
    var ErrorHandler = class _ErrorHandler {
      ...
      handleError(error, context, code = ErrorCodes.UNKNOWN_ERROR) {
        ...
        if (error instanceof YouTubeAPIError) {
          ...
          youtubeError = new YouTubeAPIError(message, code, void 0, error);
        }
        if (this.errorLogger) {
    ...
    var GetYoutubeInitData = (url) => __awaiter(void 0, void 0, void 0, function* () {
      let initdata = {};
      let apiToken = null;
      let context = null;
      try {
    ...
    var GetYoutubePlayerDetail = (url) => __awaiter(void 0, void 0, void 0, function* () {
      let initdata = {};
      try {
        const page = yield axios_1.default.get(encodeURI(url));
    ...
    var GetData = (keyword_1, ...args_1) => __awaiter(void 0, [keyword_1, ...args_1], void 0, function* (keyword, withPlaylist = false, limit = 0, options = []) {
    ...
    var nextPage = (nextPage_1, ...args_1) => __awaiter(void 0, [nextPage_1, ...args_1], void 0, function* (nextPage2, withPlaylist = false, limit = 0) {
      const endpoint = `${youtubeEndpoint}/youtubei/v1/search?key=${nextPage2.nextPageToken}`;
      try {
        const page = yield axios_1.default.post(encodeURI(endpoint), nextPage2.nextPageContext);
        ...
        const itemsResult = limit !== 0 ? items.slice(0, limit) : items;
        return { items: itemsResult, nextPage: nextPage2 };
      } catch (ex) {
        if (ex instanceof YouTubeAPIError) {
          throw ex;
        }
    ...
    var GetPlaylistData = (playlistId_1, ...args_1) => __awaiter(void 0, [playlistId_1, ...args_1], void 0, function* (playlistId, limit = 0) {
    ...
    var GetSuggestData = (...args_1) => __awaiter(void 0, [...args_1], void 0, function* (limit = 0) {
    ...
    var GetChannelById = (channelId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    var GetVideoDetails = (videoId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    var GetShortVideo = () => __awaiter(void 0, void 0, void 0, function* () {
...
//# sourceMappingURL=youtube-search-api.js.map
